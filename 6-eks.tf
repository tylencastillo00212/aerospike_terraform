...
resource "aws_iam_role_policy_attachment" "aerospike_demo-AmazonEKSVPCResourceController" {
...
resource "aws_eks_cluster" "aerospike_demo" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.aerospike_demo-AmazonEKSClusterPolicy,
    aws_iam_role_policy_attachment.aerospike_demo-AmazonEKSVPCResourceController
  ]
}